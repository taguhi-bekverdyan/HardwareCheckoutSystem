        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelNumber = table.Column<string>(maxLength: 25, nullable: true),
                    Permission = table.Column<int>(nullable: false),
                    AvatarImage = table.Column<byte[]>(nullable: true),
                    Occupation = table.Column<string>(maxLength: 25, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentStartDate = table.Column<DateTime>(nullable: true),
                    RentEndDate = table.Column<DateTime>(nullable: true),
                    Message = table.Column<string>(nullable: true),
                    LastResponseId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
